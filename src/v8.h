...
#include "allocation.h"  // NOLINT
#include "assert-scope.h"  // NOLINT
#include "utils.h"  // NOLINT
#include "flags.h"  // NOLINT
#include "globals.h"  // NOLINT

// Objects & heap
#include "objects-inl.h"  // NOLINT
#include "heap/spaces-inl.h"               // NOLINT
#include "heap/heap-inl.h"                 // NOLINT
#include "heap/incremental-marking-inl.h"  // NOLINT
#include "heap/mark-compact-inl.h"         // NOLINT
#include "log-inl.h"  // NOLINT
#include "handles-inl.h"  // NOLINT
#include "types-inl.h"  // NOLINT
#include "zone-inl.h"  // NOLINT
